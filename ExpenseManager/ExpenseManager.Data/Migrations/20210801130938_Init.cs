        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YaasPersonnelId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Banks_AspNetUsers_LastEditedUserId",
                        column: x => x.LastEditedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Branches_AspNetUsers_LastEditedUserId",
                        column: x => x.LastEditedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_AspNetUsers_LastEditedUserId",
                        column: x => x.LastEditedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Banks_LastEditedUserId",
                table: "Banks",
                column: "LastEditedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branches_LastEditedUserId",
                table: "Branches",
                column: "LastEditedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_LastEditedUserId",
                table: "Transactions",
                column: "LastEditedUserId");
        }
